...
if ($data[0] == 0) {
$sql = 'INSERT INTO membre VALUES("", "'.mysql_escape_string($_POST['login']).'", "'.mysql_escape_string(md5($_POST['pass'])).'", "'.mysql_escape_string($_POST['admin']).'")';
...
<form action="ajoutmembre.php" method="post">
  ...
  <p>
    <input name="admin" id="remember" type="checkbox">
    <label for="remember">C'est un admin ?</label>
  </p>
  </div>
  <p class="p-container">
