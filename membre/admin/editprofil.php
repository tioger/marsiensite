...
<?php 
    ...
    if (isset($_POST['imgup']) && $_POST['imgup'] == 'Enregistrer') {
            ...
            if(isset($_GET['login'])){
                $variableB=$_GET['login'];
            }
            else{
                $variableB=$_POST['login'];
            }
            ...
            $req->execute();
            header('Location: editprofil.php?login='.$variableB);
            exit();
        }
...
<head>
    ...
    <title>Modifier le Profil de <?php echo $_GET["login"] ?></title>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <!-- Debut Boucle pour affichage du profil -->
                <?php 
                    include ("../../../bdd/localhostpdo/_mysql.php");
                    // On récupère tout le contenu pour le profil demandé
                    if(isset($_GET['login'])){
                        $login=$_GET['login'];
                    }
                    else{
                    ...
                    $reponse = $bdd->query('SELECT * FROM membre WHERE login ="'.$login.'"');
                    // On affiche le profil et les input pour l'edit de celui-ci
                                                                            ...
                                                                            <div class="modal-content">
                                                                              ...
                                                                              <form method="post" action="editprofil.php">
                                                                                ...
                                                                                <div class="modal-footer">
                                                                                    <input type="hidden" name="login" value="';echo $login; echo '">
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                  ...
                                                                                  echo '</td>
                                                                                    ...
                                                                                    <td><input type="hidden" name="login" value="';echo $login; echo '"></td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
