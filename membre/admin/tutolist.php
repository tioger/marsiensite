...
<?php 
  ...
  if(isset($_POST['delete']) && $_POST['delete'] == 'Supprimer'){
    $req = $bdd->prepare("DELETE FROM Tutos WHERE id= :id");
    $req->execute(array(
        'id' => $_POST['id']
        ));
    header('Location: tutolist.php');
    exit();
  }
?>
<html lang="fr">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid" style="padding-right:0px;padding-left:0px;">
                <div id="tutocadre" style="padding-top: 10px;border:1px black solid;border-radius: 20px 20px 20px 20px;">
                  <h2>Liste des Tutos en Ligne</h2>
                  <div class="well">
                      <table class="table">
                        <thead>
                          <tr>
                        ...
                        <tbody>
                          ...
                          <?php  
                            ...
                            $reponse = $bdd->query("SELECT * FROM Tutos WHERE online= 'online' ORDER BY ID");
                                ...
                                <div class="modal fade" id="myModal<?php echo $compteurdel ; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                  <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                      <form method="POST" action="tutolist.php">
                                        <div class="modal-header">
                                          <button type="button" class="close" data-dismiss="modal" aria-label="Annuler"><span aria-hidden="true">&times;</span></button>
                                          <h4 class="modal-title" id="myModalLabel">Confirmer la suppression du tuto <?php echo $donnees['id'] ?> </h4>
                                        </div>
                  ...
                  <br>
                  <h2>Liste des Tutos en Hors-Ligne</h2>
                  <div class="well">
                      <table class="table">
                        <thead>
                          <tr>
                        ...
                        <tbody>
                          ...
                          <?php  
                            ...
                            // On récupère tout le contenu de la table commentary
                            $reponse = $bdd->query("SELECT * FROM Tutos WHERE online= '' ORDER BY ID");
                            while ($donnees = $reponse->fetch())
                            {
                              $compteurdel ++;
                          ?>
