                    ...
                    <?php if($_SESSION['login'] == $donnees['Auteur']){ 
                            echo "<div id='content'>
                                    <form method='post' action='presstemplate.php?article="; echo $donnees['PressID']; echo"'>
										<p>
											<center>
												<label for='contentedit'>Modifier Votre Article</label>
											</center>
                                            <textarea name='contentedit' style='height:100%' id='contentedit' rows='100' cols='180'  >"; echo $donnees['Contenu']; echo "</textarea>
                                        </p>
                                        <div class='footeredit'>
                                            <a class='btn btn-default' href='presstemplate.php?article="; echo $donnees['PressID']; echo"'>Annuler</a>
