        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid" style="padding-right:0px;padding-left:0px;">
                <div id="tutocadre" style="padding-top: 10px;border:1px black solid;border-radius: 20px 20px 20px 20px;">
                  <h2>Liste des Articles de Presse</h2>
                  <div class="well">
                      <table class="table">
                        <thead>
                          <tr>
                        ...
                        <tbody>
                          ...
                          <?php  
                            ...
                            $reponse = $bdd->query("SELECT * FROM Press ORDER BY PressID");
                  ...
                  <div class="modal small hide fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                      ...
                      <div class="modal-body">
                          <p class="error-text">Etes vous sur de vouloir supprimer cet article?</p>
                      </div>
