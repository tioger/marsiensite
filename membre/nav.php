            ...
            <ul class="nav navbar-right top-nav">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" id="dmwidth">
                        <?php if(isset($_SESSION['admin'])) echo "<li><a href='userlist.php'><i class='fa fa-fw fa-user'></i> Liste des Membres</a></li><li class='divider'></li>"; ?>
                        <?php if(isset($_SESSION['admin'])) echo "<li><a href='ajoutmembre.php'><i class='fa fa-fw fa-user'></i> Ajout Membre</a></li><li class='divider'></li>"; ?>
                        <?php if(isset($_SESSION['admin'])) echo "<li><a href='ajoutadmin.php'><i class='fa fa-fw fa-user'></i> Ajout Admin</a></li><li class='divider'></li>"; ?>
                         <li>
